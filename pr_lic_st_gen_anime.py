...
plsg['url_mal'] = 'https://myanimelist.net/anime/' + plsg.anime_id.apply(str)
plsg['url_shiki'] = 'https://shikimori.one/animes/' + plsg.anime_id.apply(str)

plsg.duration = plsg.duration.apply(change_dur)

plsg.image_url = plsg.image_url.apply(change_url_img)
...
plsg.rename(columns={0: 'anime_id',
                     1: 'title',
                     2: 'title_english',
                     3: 'title_japanese',
                     4: 'title_synonyms',
