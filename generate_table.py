...
anime = anime.replace(to_replace={0: r'&#039;', 1: r'&amp;'}, value={0: "'", 1: "&"}, regex=True)
...
buf.to_sql(anime_table, index=False, if_exists='append', con=engine)
...
relation.to_sql(relation_table, index=False, if_exists='append', con=engine)
